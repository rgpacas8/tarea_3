...
int main(void) {
	...
	xTaskCreate(task_Seconds, "task_Seconds", 500, (void*)&parameters_task, configMAX_PRIORITIES,
			NULL);
	xTaskCreate(task_Minutes, "task_Minutes", 500, (void*)&parameters_task, configMAX_PRIORITIES,
			NULL);
	xTaskCreate(task_Hours, "task_Hours", 500, (void*)&parameters_task, configMAX_PRIORITIES,
			NULL);
